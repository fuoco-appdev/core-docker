...
export host="\$host" server_port="\$server_port" http_x_csrf_token="\$http_x_csrf_token" remote_addr="\$remote_addr" http_authorization="\$http_authorization" http_cookie="\$http_cookie" proxy_add_x_forwarded_for="\$proxy_add_x_forwarded_for" scheme="\$scheme" http_upgrade="\$http_upgrade" connection_upgrade="\$connection_upgrade"
